...
//		System.exit(1);
	...
	public static ArrayList<SemTextInstance> read(String filename, SemTextDataManager dm, String ids_filename, boolean isTrain, String lang) throws IOException{
...
//				if (lang.equals("en")) len--; //remove the last punctuation.
				WordToken[] wTokens = new WordToken[len + 1];
				wTokens[0] = new WordToken("*LeaveRoot*");
				for(int k = 0; k < len; k++){
					wTokens[k + 1] = new WordToken(words[k]);
				}
