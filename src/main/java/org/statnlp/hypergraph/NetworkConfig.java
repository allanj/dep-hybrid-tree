...
public class NetworkConfig {
	...
	public static boolean LOAD_PRETRAIN_WEIGHT = false;
	public static boolean FIX_PRETRAIN_WEIGHT = false;
	public static double[] pretrainWeights = null;
	
	public static boolean SAVE_EPOCH_MODEL = false;
	public static String EPOCH_MODEL_FILE = null;
	public static String EPOCH_NN_MODEL_FILE = null;
}